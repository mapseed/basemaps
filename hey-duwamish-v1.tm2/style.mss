...
//  polygon-clip: false;
//  [zoom>=12] {
//      polygon-pattern-file: url(img/pattern/fishrun_16.png);
//      polygon-pattern-opacity: 0.25;
//      polygon-pattern-alignment: global;
//    }
//    [zoom>=13] { polygon-pattern-file: url(img/pattern/fishrun_32.png); }
//    [zoom>=14] { polygon-pattern-file: url(img/pattern/fishrun_64.png); }
// }
...
#waterway {
  ...
  [type='ditch'] {
    ...
    [zoom>=8] { line-width: 0.6; line-smooth: 0.5; }
    [zoom>=10] { line-width: 0.6; line-cap: round; }
  ...
  [type='canal'] {
    ...
    [zoom>=10] { line-width: 0.6; line-cap: round; line-smooth: 0.5; }
    [zoom>=12] { line-width: 0.6; }
  }
  [type='stream'] {
    line-color: mix(@water,@water_dark,60);
